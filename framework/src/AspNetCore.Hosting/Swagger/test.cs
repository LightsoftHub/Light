...
public class SubgroupDescriptionProvider(IOptions<ApiExplorerOptions> options) : IApiDescriptionProvider
{
    private readonly IOptions<ApiExplorerOptions> options = options;
